...
function filterProfanity(text) {
    ...
    profanityList.forEach(profanity => {
        ...
        lowercasedText = lowercasedText.replace(regex, '*'.repeat(profanity.length));
    });

    // Substitui URLs
    lowercasedText = lowercasedText.replace(urlRegex, '***URL***');

    // Substitui emails
    lowercasedText = lowercasedText.replace(emailRegex, '***EMAIL***');
